...
export default function LoggingIn() {
  return (
    <div>
      ...
      <div className="w-screen h-screen relative lg:pt-10">
        <section className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-2/3 h-3/4 bg-white">
          <div>
